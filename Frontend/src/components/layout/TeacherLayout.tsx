      ...
      >
        ...
        <nav className="flex-1 px-4 py-6 space-y-1.5 overflow-y-auto">
          {navItems.map((item) => {
            ...
            // Special case for Reading nested under classes
            if (item.href === '/teacher/reading' && location.pathname.includes('/reading')) {
              isActive = true;
            }
            // If Reading is active, Lớp học shouldn't be active just because it has /classes/ in URL
            if (item.href === '/teacher/classes' && location.pathname.includes('/reading')) {
              isActive = false;
            }
