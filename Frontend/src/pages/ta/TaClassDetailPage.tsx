    ...
    <div className="space-y-6">
      ...
      {activeTab === 'members' && (
        <Card className="p-6">
          ...
          <div className="mb-6"><StudentSearchDropdown classId={parseInt(id!)} onSelect={handleSelectExistingStudent} onAddNoAccount={handleAddNoAccountStudent} isAdding={isAddingStudent} /></div>
