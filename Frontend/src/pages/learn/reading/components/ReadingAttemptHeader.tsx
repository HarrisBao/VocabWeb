  ...
  return (
    <header className="sticky top-0 z-20 bg-white border-b border-gray-200 px-4 py-3 flex items-center justify-between shadow-sm">
      ...
      <div className="flex items-center space-x-6 flex-shrink-0">
        ...
        <div className={	ext-sm font-bold px-3 py-1.5 rounded-md }>
        ...
        {!isReview ? (
          ...
          <Button onClick={() => navigate(/student/classes//reading//attempts//result)} className="bg-gray-100 hover:bg-gray-200 text-gray-700 font-bold px-6 py-2 shadow-sm rounded-lg transition-all">
            Quay lại kết quả
          </Button>
        )}
      </div>
