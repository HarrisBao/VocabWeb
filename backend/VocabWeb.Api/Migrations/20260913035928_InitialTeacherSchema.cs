...
{
    /// <inheritdoc />
    public partial class InitialTeacherSchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FixedLinkToken = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VocabularySets_AspNetUsers_TeacherId",
                        column: x => x.TeacherId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClassLessons_VocabularySets_VocabularySetId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EnabledTypes = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TotalQuestions = table.Column<int>(type: "int", nullable: false),
                    TimeLimitMinutes = table.Column<int>(type: "int", nullable: true),
                    PassScore = table.Column<decimal>(type: "decimal(4,1)", precision: 4, scale: 1, nullable: false),
                    IsArchived = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tests_VocabularySets_VocabularySetId",
                        column: x => x.VocabularySetId,
                        principalTable: "VocabularySets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VocabularyItems_VocabularySets_VocabularySetId",
                        column: x => x.VocabularySetId,
                        principalTable: "VocabularySets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VocabularyItemId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AttemptAnswers_VocabularyItems_VocabularyItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttemptAnswers_VocabularyItemId",
                table: "AttemptAnswers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClassLessons_VocabularySetId",
                table: "ClassLessons",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tests_VocabularySetId",
                table: "Tests",
                column: "VocabularySetId");

            migrationBuilder.CreateIndex(
                name: "IX_VocabularyItems_VocabularySetId",
                table: "VocabularyItems",
                column: "VocabularySetId");

            migrationBuilder.CreateIndex(
                name: "IX_VocabularySets_TeacherId",
